...
def _guard_official_docker_root_gateway() -> None:
    ...
    # Case 1 (legacy): official Docker checkout where the entrypoint should have
    # dropped privileges. Checked first because it is the most specific
    # diagnosis: when we are inside the official image, that is the actionable
    # cause regardless of who owns the workspace.
