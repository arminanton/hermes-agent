...
# for request, interaction, client-session, and agent-task correlation. Strip
# them on both sides before asserting structural equality.
_VOLATILE_COPILOT_HEADERS = (
    "X-Request-Id",
    "X-Interaction-Id",
    "X-Agent-Task-Id",
    "X-Client-Session-Id",
...
def test_copilot_base_url_uses_canonical_text_header_profile(mock_openai):
    ...
    agent._apply_client_headers_for_base_url("https://api.githubcopilot.com")
