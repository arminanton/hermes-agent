...
def skill_view(
    ...
    try:
        ...
        for search_dir in all_dirs:
            ...
            # `name: autoplan`). `/skills` / `skills_list()` surfaces frontmatter
            # names, so skill_view must resolve them too even when the on-disk
            # directory is a shorter category/alias.
